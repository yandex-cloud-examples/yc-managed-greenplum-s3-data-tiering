...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2013?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2014?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_export')
distributed RANDOMLY;
...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2015?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_export')
distributed RANDOMLY;
...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2016?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_export')
distributed RANDOMLY;
...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2017?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_export')
distributed RANDOMLY;
...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2018?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_export')
distributed RANDOMLY;
...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2019?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_export')
distributed RANDOMLY;
...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2020?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_export')
distributed RANDOMLY;
...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2021?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_export')
distributed RANDOMLY;
...
(like ny_taxi_src_gp)
LOCATION (
	'pxf://<bucket-name>/ny-taxi-pxf-rw/2022?PROFILE=s3:parquet&accesskey=<s3-access-key>&secretkey=<s3-secret-key>&endpoint=storage.yandexcloud.net&PARQUET_VERSION=v2&COMPRESSION_CODEC=snappy')
FORMAT 'CUSTOM' (FORMATTER='pxfwritable_export')
distributed RANDOMLY;
